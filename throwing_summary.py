...
game_date_str = '2024-09-26'  # Adjust as necessary for the game being summarized
...
game_data_passing = passing_plays[passing_plays['game_id'] == '2024_04_DAL_NYG'] ### follow format YEAR_WEEK_AWAY_HOME 2023_12_BUF_PHI
game_data_rushing = rushing_plays[rushing_plays['game_id'] == '2024_03_DAL_NYG']
...
def qb_dashboard(game_data_passing: pd.DataFrame, headshot: Image, team_abb: str, summary_df: pd.DataFrame, pass_distance_summary: pd.DataFrame, quarter_positions, save_path: str = None):
    ...
    ax_bio.text(0.5, 0.1, f'2024 Week 4 Throwing Summary vs. Dallas', fontsize=18, ha='center', fontstyle='italic')  # Still manually set game information
    ax_bio.axis('off')
...
qb_dashboard(game_data_passing, headshot, "NYG", summary_df, pass_distance_summary, quarter_positions, save_path=save_path)
